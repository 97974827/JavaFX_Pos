...
public class Acr1251U_1252U extends PcscReader
{
	...
	public enum LED_STATE
    {
        ...
        private int _id;
        LED_STATE(int id) {this._id = id;}
        public int getLedState() {return _id;}
    }
	...
	public enum PARAMETER_OPTION
    {
        ...
        PARAMETER_OPTION(int id) {this._id = id;}
        public int getParameterOption() {return _id;}
    }
    ...
    { 
        ...
        private final int _id;
        LED_BUZZER_BEHAVIOR(int id) {this._id = id;}
        public int getBuzzerBehavior() {return _id;}
    }
    ...
    { 
        ...
        private final int _id;
        POLLING_SETTING(int id) {this._id = id;}
        public int getPollingSetting() {return _id;}
    }
    ...
    public static class LedStatus
    {
        ...
        public LED_STATE getRed() { return _red; }
        public void setRed(LED_STATE value) { this._red = value; }
        
        public LED_STATE getGreen() { return _green; }
        public void setGreen(LED_STATE value) { this._green = value; }
    ...
    public static class AutoPiccPollingSettings
    {
        ...
        public POLLING_SETTING getAutoPiccPolling() { return _autoPiccPolling; }
        public void setAutoPiccPolling(POLLING_SETTING value) { this._autoPiccPolling = value; }
        
        public POLLING_SETTING getTurnOffAntennaIfNoPicc() { return _turnOffAntennaIfNoPicc; }
        public void setTurnOffAntennaIfNoPicc(POLLING_SETTING value) { this._turnOffAntennaIfNoPicc = value; }
        
        public POLLING_SETTING getTurnOffAntennaIfPiccInactive() { return _turnOffAntennaIfPiccInactive; }
        public void setTurnOffAntennaIfPiccInactive(POLLING_SETTING value) { this._turnOffAntennaIfPiccInactive = value; }

        public POLLING_SETTING getActivatePiccWhenDetected() { return _activatePiccWhenDetected; }
        public void setActivatePiccWhenDetected(POLLING_SETTING value) { this._activatePiccWhenDetected = value; }
        
        public POLLING_SETTING getEnforceIso14443APart4() { return _enforceIso14443APart4; }
        public void setEnforceIso14443APart4(POLLING_SETTING value) { this._enforceIso14443APart4 = value; }
	...
	{
		super();
		this.setControlCode(IOCTL_SMARTCARD_ACR1251_ACR1252_ESCAPE_COMMAND);
	}
...
//		uDuration = (byte) 0x01;
	    ...
	    byte[] uCommand = new byte[] { (byte) 0xFF, 0x00, 0x40, 0x00, 0x04, 0x01, 0x00, 0x01, 0x01};
